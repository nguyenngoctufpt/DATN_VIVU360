        ...
        <View style={styles.modalBackdrop}>
          <View style={[styles.modalCard, { backgroundColor: theme.cardGlass, borderColor: theme.border, height: 280 }]}>
            ...
            <View style={{ flex: 1, padding: 16 }}>
              ...
              <TextInput
                style={[styles.formInputGroup, { color: theme.textPrimary, backgroundColor: theme.searchBg, borderColor: theme.searchBorder, marginTop: 6, height: 80, textAlignVertical: 'top', paddingTop: 8 }]}
                multiline
